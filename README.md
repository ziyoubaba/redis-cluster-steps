...
`docker run --rm -it --net=host redis:5.0.8 redis-cli -a 123456 --cluster create 192.168.56.101:7000 192.168.56.101:7001 192.168.56.101:7002 192.168.56.101:7100 192.168.56.101:7101 192.168.56.101:7102 --cluster-replicas 1`
 
 会自动生成配置信息。这里服务运行在”192.168.56.101“上，看自身机器的局域网ip相应修改。
 另外：因为有人说因为服务需要密码，所以在创建集群的时候需要加上' -a <requirepass> '参数。这里应该是'-a 123456'。
 
集群创建完成。访问任何节点，都可以取到集群中分布的全部redis值。
